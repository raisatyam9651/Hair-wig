...
<h1 class="font-display-lg text-3xl md:text-headline-lg text-on-surface leading-tight text-balance">Hair System Maintenance &amp; Styling in Dwarka: Meticulous Care for Enduring Perfection</h1>
...
<img alt="Hair System Maintenance" class="relative rounded-[32px] royal-shadow w-full h-auto transition-transform duration-700 group-hover:scale-[1.02]" src="assets/after-before.png"/>
</div>
</div>
</section>
...
<div>
<p class="font-label-md text-on-surface">Specialized Products</p>
<p class="text-sm text-on-surface-variant">We exclusively use sulfate-free, system-safe care products.</p>
</div>
</li>
<li class="flex items-start gap-4">
<span class="material-symbols-outlined text-primary" data-icon="check_circle" data-weight="fill"></span>
<div>
<p class="font-label-md text-on-surface">Scalp Health First</p>
<p class="text-sm text-on-surface-variant">Our treatments prioritize hygiene and anti-irritation prep.</p>
</div>
</li>
<li class="flex items-start gap-4">
<span class="material-symbols-outlined text-primary" data-icon="check_circle" data-weight="fill"></span>
<div>
<p class="font-label-md text-on-surface">Senior Hair Stylists</p>
<p class="text-sm text-on-surface-variant">All maintenance cuts and styling are done by experienced professionals.</p>
</div>
</li>
</ul>
...
<!-- Bento Grid - Maintenance Services -->
...
<h5 class="font-label-md mb-1">Side Blending Cut</h5>
<p class="text-xs opacity-70">Bridges natural side-hair with the patch.</p>
</div>
<div class="p-4 rounded-2xl bg-white/10 border border-white/20">
<h5 class="font-label-md mb-1">Fiber Rejuvenation Treatment</h5>
...
<div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            For optimal hygiene and aesthetics, we recommend professional maintenance every 3 to 4 weeks. This frequency ensures the bio-adhesive remains secure, the scalp is properly cleansed, and the hair system maintains its pristine condition. Personal lifestyle and skin type may slightly alter this schedule.
                        </div>
</details>
<details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
<summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
                            Can I wash my hair system at home between sessions?
                            <span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
</summary>
<div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            Yes, you can gently wash the hair system at home. We will guide you on the correct techniques, sulfate-free shampoos, and leave-in conditioners to use. However, the deep cleaning of the base and scalp re-bonding must be done professionally at our studio.
                        </div>
</details>
<details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
<summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
...
<div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            A standard maintenance session takes approximately 60 to 90 minutes. This includes safe removal, base cleaning, scalp conditioning, re-bonding, and final styling. More intensive scalp treatments or color restorations may take up to 2 hours.
                        </div>
</details>
<details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
<summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
                            What happens if I delay my maintenance service?
                            <span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
</summary>
<div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            Delaying maintenance beyond 5 weeks can lead to adhesive breakdown, making the system loose and slide. It can also cause sweat build-up, scalp odor, skin irritation, and damage to the base materials, reducing the system's lifespan.
                        </div>
</details>
</div>
</div>
