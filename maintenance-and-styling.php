...
<img alt="Hair System Maintenance" class="relative rounded-[32px] royal-shadow w-full h-[350px] md:h-[600px] object-cover transition-transform duration-700 group-hover:scale-[1.02]" src="assets/main-beofre-and-after.png"/>
...
<p class="font-body-md text-on-surface">Professional cleaning, re-bonding, and custom styling to maintain an undetectable look.</p>
</div>
</div>
</div>
</section>
