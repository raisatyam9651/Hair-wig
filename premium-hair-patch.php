...
<h1 class="font-display-lg text-[32px] md:text-display-lg text-on-surface leading-tight text-balance">Premium Hair Patch in Dwarka: Bespoke Artistry for Natural Restoration</h1>
...
<img alt="Premium Hair Restoration" class="relative rounded-[32px] royal-shadow w-full h-[350px] md:h-[600px] object-cover transition-transform duration-700 group-hover:scale-[1.02]" src="assets/before-andafter.png"/>
