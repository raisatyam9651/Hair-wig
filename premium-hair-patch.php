...
<h1 class="font-display-lg text-2xl md:text-headline-lg text-on-surface leading-tight text-balance">Premium Hair Patch in Dwarka | Best Hair Patch in Dwarka</h1>
...
<img alt="Premium Hair Restoration" class="relative rounded-[32px] royal-shadow w-full h-auto" src="assets/rintu-hair-patch-before-and-after.png"/>
</div>

<p class="font-body-lg text-body-lg text-on-surface-variant max-w-xl">Get custom hair patches near you. Our studio designs premium hair patches for men in Dwarka. Enjoy a natural, secure, and undetectable fit with same-day fixing.</p>
...
<img alt="Premium Hair Restoration" class="relative rounded-[32px] royal-shadow w-full h-auto transition-transform duration-700 group-hover:scale-[1.02]" src="assets/rintu-hair-patch-before-and-after.png"/>
</div>
</div>
</section>
...
<p class="font-body-lg text-on-surface-variant mb-12">Clarity is the first step toward confidence. Here is everything you need to know about our luxury hair systems.</p>
                        <div class="w-full h-[400px] flex items-center justify-center bg-white rounded-3xl royal-shadow overflow-hidden border border-surface-variant/30">
                            <img alt="Hair Patch for Men" class="w-full h-full object-contain" src="assets/rintu-hair-patch-before-and-after.png"/>
                        </div>
</div>
<div class="space-y-4">
...
<img alt="Before and After" class="absolute inset-0 w-full h-full object-cover" src="assets/rintu-hair-patch-before-and-after.png"/>
