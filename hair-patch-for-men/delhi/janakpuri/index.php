...
$location_slug = 'janakpuri';
$landmarks_str = 'Janakpuri District Centre, Tilak Nagar, Janakpuri West Metro Station';
$connectivity_str = 'connected directly to Dwarka via the Blue Line Metro, just a 15-minute drive via the Dwarka Flyover.';
