...
$location_slug = 'rajouri-garden';
$landmarks_str = 'TDI Mall, Rajouri Garden Metro Station, Main Market';
$connectivity_str = 'directly connected via the Blue Line Metro to Dwarka, making it extremely convenient for West Delhi shoppers.';
