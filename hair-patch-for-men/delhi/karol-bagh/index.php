...
$location_slug = 'karol-bagh';
$landmarks_str = 'Ajmal Khan Road, Ghaffar Market, Karol Bagh Metro Station';
$connectivity_str = 'accessible via the Blue Line Metro directly, making it an easy direct commute from Karol Bagh.';
