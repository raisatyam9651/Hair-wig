...
<body class="bg-background text-on-background font-body-md selection:bg-primary-fixed-dim selection:text-on-primary-fixed antialiased">
    ...
    <main class="pt-20">
        ...
        <section class="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative group">
                ...
                <img alt="Bespoke Hairline Designing" class="relative rounded-[32px] royal-shadow w-full h-[350px] md:h-[600px] object-cover transition-transform duration-700 group-hover:scale-[1.02]" src="assets/Custom%20Hairline%20Design.png" />
                <div class="absolute bottom-8 left-8 glass-card p-6 rounded-2xl max-w-xs royal-shadow">
                    ...
                    <p class="font-body-md text-on-surface">Every hairline is custom-mapped to match your natural facial symmetry.</p>
                </div>
            </div>
        </section>
                    ...
                    <div class="lg:col-span-8 space-y-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="glass-card p-8 rounded-3xl space-y-4 border-primary/10">
                                ...
                                <p class="font-body-md text-on-surface-variant">Each hairline undergoes 120+ hours of hand-ventilation, ensuring that each hair strand exits the base at a natural angle, identical to your biological scalp.</p>
                            </div>
                            <div class="glass-card p-8 rounded-3xl space-y-4 border-primary/10">
                        ...
                        <div class="sticky top-32 glass-card p-10 rounded-[32px] royal-shadow space-y-8 border-primary/20">
                            ...
                            <ul class="space-y-6">
                                <li class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p class="font-label-md text-on-surface">100% Custom Stenciling</p>
                                        <p class="text-sm text-on-surface-variant">Individually measured and drawn for your head shape.</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-4">
                                    <span class="material-symbols-outlined text-primary" data-icon="check_circle" data-weight="fill"></span>
                                    <div>
                                        <p class="font-label-md text-on-surface">Age-Appropriate Recessions</p>
                                        <p class="text-sm text-on-surface-variant">Designed to look distinguished and natural as you age.</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-4">
                                    <span class="material-symbols-outlined text-primary" data-icon="check_circle" data-weight="fill"></span>
                                    <div>
                                        <p class="font-label-md text-on-surface">Sweat & Water Resistant</p>
                                        <p class="text-sm text-on-surface-variant">Secure enough for workouts, swimming, and styling.</p>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="space-y-4">
                    <details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow" open="">
                        <summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
                            How is a custom hairline designed?
                            <span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
                        </summary>
                        <div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            We use facial mapping techniques to draw a custom blueprint. We then transfer this blueprint to the hair system base, choosing the hair angles and color gradients to match your existing hair.
                        </div>
                    </details>
                    <details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
                        <summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
                            Can I style my hair backwards (exposed hairline)?
                            <span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
                        </summary>
                        <div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            Absolutely. Our Swiss lace front and ultra-thin skin systems are designed specifically for exposed hairlines, allowing you to style your hair back with complete confidence.
                        </div>
                    </details>
                    <details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
                        <summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
                            How long does a hairline system stay secure?
                            <span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
                        </summary>
                        <div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                    ...
                    <details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
                        <summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
                            Is the design visible up close?
                            <span class="material-symbols-outlined group-open:rotate-180 transition-transform">expand_more</span>
                        </summary>
                        <div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
        ...
        <!-- CTA Section (Your Transformation Awaits) -->
