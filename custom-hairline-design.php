    ...
    <main class="pt-20">
        ...
        <section class="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative group">
                ...
                <img alt="Bespoke Hairline Designing" class="relative rounded-[32px] royal-shadow w-full h-auto transition-transform duration-700 group-hover:scale-[1.02]" src="assets/main-beofre-and-after.png" />
