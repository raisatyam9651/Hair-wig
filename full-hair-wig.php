...
<h1 class="font-display-lg text-[32px] md:text-display-lg text-on-surface leading-tight text-balance">Full Wigs in Dwarka: Bespoke Artistry for Natural Restoration</h1>
...
<div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                            With proper maintenance at our Dwarka center, a high-quality human hair system typically lasts between 6 to 12 months. We provide comprehensive care guides and professional servicing to maximize longevity.
                        </div>
</details>
<details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow">
<summary class="list-none flex justify-between items-center cursor-pointer font-headline-md text-on-surface">
