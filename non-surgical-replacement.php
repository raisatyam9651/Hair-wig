...
<h1 class="font-display-lg text-3xl md:text-headline-lg text-on-surface leading-tight text-balance">Non-Surgical Hair Replacement in Dwarka: Bespoke Artistry for Natural Restoration</h1>
...
<img alt="Premium Non-Surgical Hair Replacement" class="relative rounded-[32px] royal-shadow w-full h-auto transition-transform duration-700 group-hover:scale-[1.02]" src="assets/winter-before-and-after-hair-pathc.png"/>
</div>
</div>
</section>
