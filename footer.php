        ...
        <div class="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>australian-hair-patch-dwarka">Australian Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>bmw-hair-patch-dwarka">BMW Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>filament-hair-patch-dwarka">Filament Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>superior-filament-hair-patch-dwarka">Superior Filament Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>monofilament-hair-patch-dwarka">Monofilament Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>mono-silk-hair-patch-dwarka">Mono Silk Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>mirage-hair-patch-dwarka">Mirage Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>french-lace-hair-patch-dwarka">French Lace Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>front-lace-hair-patch-dwarka">Front Lace Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>full-lace-hair-patch-dwarka">Full Lace Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
                        href="<?php echo $path_prefix; ?>poly-fuse-hair-patch-dwarka">Poly Fuse Hair Patch</a>
                    <a class="text-white/80 hover:text-primary-fixed transition-colors font-body-md text-sm"
