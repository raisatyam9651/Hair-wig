            ...
            <div
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center my-auto">
                    ...
                    <div class="relative group">
                        ...
                        <img alt="Bespoke Hair Replacement" class="relative rounded-[32px] royal-shadow w-full h-[350px] md:h-[500px] object-cover transition-transform duration-700 group-hover:scale-[1.02]" src="assets/hero-section.png" />
            ...
            <div
                ...
                <div class="flex flex-col gap-6 fade-in-section">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                        At Growig Hair Solution, we specialize in premium non-surgical hair replacement in Dwarka. Our
