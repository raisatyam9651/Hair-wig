<?php
// Script to generate localized SEO landing pages for "hair wig for man in [location]"
// Target structure: hair-patch-for-men/delhi/[location]/index.php
...
$current_metadata = [
    ...
    'url' => "https://growighairsolution.com/hair-patch-for-men/delhi/$location_slug/",
...
$breadcrumb_schema = [
    ...
    "itemListElement" => [
        ...
        [
            "@type" => "ListItem",
            "position" => 2,
            "name" => "Hair Patch for Men in Delhi",
            "item" => "https://growighairsolution.com/hair-patch-for-men/delhi/$location_slug/"
        ],
        [
            "@type" => "ListItem",
            "position" => 3,
    ...
    <section class="py-section-gap">
        <div class="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-16 items-center">
            <div class="z-10 md:space-y-8 space-y-6">
                <span class="inline-block py-1 px-4 rounded-full bg-primary/10 text-primary font-label-md">PREMIUM RESTORATION IN DELHI</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                <div class="lg:col-span-8 space-y-12">
                    <div class="space-y-6">
                        ...
                        <p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
                            Our studio is located at Ramphal Chowk, Sector 7 Dwarka, which is <?php echo $connectivity_str; ?>. We welcome clients from all across Delhi to experience premium, private restoration sessions. Each hair patch is lightweight, breathable, and designed for an active lifestyle.
                        </p>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="glass-card p-8 rounded-3xl space-y-4 border-primary/10">
                            ...
                            <p class="font-body-md text-on-surface-variant">Our systems feature French lace, Swiss lace, and ultra-thin monofilament bases that provide optimal scalp ventilation for Delhi's climate.</p>
                        </div>
                    </div>
                    <div class="space-y-6">
            ...
            <div class="space-y-4">
                <details class="group glass-card p-6 rounded-2xl border-primary/10 royal-shadow" open>
                    ...
                    <div class="mt-4 font-body-md text-on-surface-variant leading-relaxed">
                        Our studio is located at Sector 7, Dwarka. Since it is <?php echo $connectivity_str; ?>, clients from <?php echo $location_name; ?> can easily book a private consultation, complete their mapping, and get their hair system fitted on the same day.
                    </div>
                </details>
...
if (!file_exists('hair-patch-for-men/delhi')) {
    mkdir('hair-patch-for-men/delhi', 0755);
}

foreach ($locations as $loc) {
    $dir = 'hair-patch-for-men/delhi/' . $loc['slug'];
    if (!file_exists($dir)) {
        mkdir($dir, 0755, true);
    }
...
echo "All location pages generated successfully!\n";
?>
